...
export const metadata: Metadata = {
  ...
  description:
    "Generate perfect AI-powered packing lists in seconds. Free, personalized travel packing checklists for any trip. Never forget essentials again!",
  keywords: [
    "packing list",
    "travel checklist",
    "AI packing",
  ...
  openGraph: {
    ...
    description:
      "Generate perfect AI-powered packing lists in seconds. Free, personalized travel packing checklists for any trip.",
  ...
  twitter: {
    ...
    title: "Packmind AI - Smart Packing Lists",
    description:
      "Generate perfect AI-powered packing lists in seconds. Free, personalized travel packing checklists.",
